...
*   **/chart 共振标记按「好 / 坏 / 中性」三色区分**：主图共振标记不再统一紫粉色 + 「共振」二字，改用**语义色 + 形状**表意——**看多绿 ▲ / 看空红 ▼ / 多空分歧灰 ◆**，一眼区分信号好坏；当看多 / 看空两侧指标**同时**达标记为「多空分歧（中性）」，提示信号相互打架需谨慎。悬停读数条按方向给出「看多共振 / 看空共振 / 多空分歧」标题与命中指标明细，工具栏「共振」开关图标也换成 `▲◆▼` 三色三形态。
